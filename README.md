...
<img src="screenshots/prism_logo.png" width="180" alt="Prism logo">
...
<div align="center">
<img src="screenshots/prism-home.png" width="900" alt="Prism main interface">
</div>
...
<div align="center">
<img src="screenshots/research-summary.png" width="900" alt="Prism research summary">
</div>
...
<div align="center">
<img src="screenshots/detailed-report.png" width="900" alt="Prism detailed research report">
</div>
...
<div align="center">
<img src="screenshots/sources.png" width="900" alt="Prism research sources">
</div>
...
**`app.py`**  
Contains the Streamlit user interface for Prism.

**`main.py`**  
Contains the main research-agent logic and orchestration.

**`tools.py`**  
Contains research tools such as web search, Wikipedia retrieval, and saving research results.

**`check_models.py`**  
Used to check model availability/configuration.
...
**`Researches/`**  
Stores generated research output files.
...
Add the required API key according to your implementation:
...
```text
Who is Cristiano Ronaldo and what are his major career achievements?
```

```text
How has artificial intelligence changed software development?
```

```text
What are the major developments in quantum computing?
```
...
For current or time-sensitive topics, Prism can use its latest-information search workflow.

---

# 📄 Research Output

Prism provides two major forms of output:

### 📝 Research Summary

A concise overview containing the most important findings.

### 📚 Detailed Research Report

A longer report containing additional context, explanations, developments, important facts, and a conclusion.

Research can also be saved as a `.txt` file inside:
...
Prism may use API keys and other environment variables.

For security:

- Never commit `.env` files.
- Never publish API keys in source code.
- Never share private credentials in screenshots.
...
- 🖼️ Better image selection for research topics
- 📰 More reliable source extraction
- 🔗 Clickable source links
- 📊 Data visualization
- 📄 PDF report generation
- 📝 DOCX report generation
- 🧠 Improved multi-step agent planning
- 🔍 More research tools
- 💬 Conversational follow-up questions
- ⚡ Faster research execution
- 🗂️ Research history and document management
- ☁️ Cloud deployment
